...
Versión funcional 0.2.0 para controlar el proyecto con ocho sprints. Aplicación independiente del portal de afiliaciones: no utiliza sus usuarios, cookies, tablas, correo, IA, S3 ni configuración de secretos. No muestra ni expone valores monetarios o condiciones de pago.
...
El portal muestra ahora el motor de análisis y el portal administrativo de MACAO, la integración con APEX y la infraestructura del banco. Las vistas Responsabilidades e Infraestructura y Gemini recogen el alcance técnico, el modelo `gemini-3.5-flash-lite` y la responsabilidad del banco ante su deprecación. Los valores monetarios se mantienen exclusivamente en la propuesta documental; no se incluyen en la interfaz ni en la API del portal.
